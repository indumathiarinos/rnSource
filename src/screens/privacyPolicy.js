                ...
                <View style={{ flex: 8, flexDirection: 'column' }}>
                    <View style={{
                        ...
                        <ScrollView style={{ backgroundColor: '#F9F9F9', borderRadius: 1, flexWrap: 'nowrap' }}>
                            <HTMLView value={htmlcontents}  ></HTMLView>
                        </ScrollView>
                    </View>
                </View>
