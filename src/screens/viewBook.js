...
<TouchableOpacity style={{ padding: '3%', marginRight: '3%' }} onPress={() => this.backpress()}>
...
<Modal1 isVisible={this.state.collectionModal}
  onBackdropPress={() => this.setState({ collectionModal: false,expanded:false,sectionExpand:false})}>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => this.readlaterAdd(this.state.getuserid,this.state.getpostid,this.state.gettypeid)}>
