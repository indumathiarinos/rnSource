...
componentDidMount() {
  AsyncStorage.getItem('col_id').then((value) => this.setState({ coll_id : value })).done();
...
handleBackButtonClick() {
  ...
  backpress=()=>{
    ...
    // this.props.navigation.navigate('collectionDetail',{'collId':this.state.coll_id});
  ...
  goToCollection=(title)=>{
    if(title=="Newest"){
      AsyncStorage.setItem('newsectionFilter',"DESC");
    }else if(title=="Oldest"){
      AsyncStorage.setItem('newsectionFilter',"ASC");
    }else if(title=="Most Popuplar"){
      AsyncStorage.setItem('newsectionFilter',"MP");
    }
    this.props.navigation.navigate('pins1');
    // this.props.navigation.navigate('collectionDetail',{'collId':this.state.coll_id});
...
export default connect(mapStateToProps,mapDispatchToProps)(SectionFilter);