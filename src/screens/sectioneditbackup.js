            ...
            return (
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: '#ffff' }}>
                   <View style={{height:'8%',backgroundColor:'#27A291',justifyContent:'center'}}>
                    ...
                    {this.state.secCollid==""?null:<Text style={{fontSize:24,color:'#000',margin:'2%',padding:'1%',fontFamily:'Montserrat-Light',marginRight:0}}> / </Text>}

                   {this.state.secCollid==""?null:<Text style={{fontSize:24,color:'#27A291',margin:'2%',marginLeft:0,marginTop:'3%',padding:'1%',fontFamily:'Montserrat-Regular',marginRight:0}}>Section</Text> }
                   </View>
