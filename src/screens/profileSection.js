...
pressIcon = (item) => {
  ...
  sectionData = sectionData.map(e => {
      // if (item.id === e.id) {
          ...
          return this.props.navigation.navigate('profileReads')
...
// alert('I am profile section page')
...
setTimeout(() => {
  ...
  console.log('profiel kiii ',this.state.profile_userid,this.state.profileColl,this.state.profile_userid)
        }, 3000)
}
