...
class Pins extends Component {
    ...
    renderItem_card({ item }) {
     ...
     {/* <View style={{ marginLeft:10,marginRight:10,  alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text numberOfLines={2} style={{ fontSize: 16,width: width / 2 - 40,fontWeight: 'bold',textAlign:'left',marginTop:5,marginBottom:5}}>{item.page_url}</Text>
                    <Text style={{ color: '#707070', fontSize: 14,width: width / 2 - 40,textAlign:'left',marginTop:5,marginBottom:5 }}>Page {item.rownum}</Text>
