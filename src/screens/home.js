...
class CreateCollectionEdit extends Component {
    constructor(props){
        super(props)
  this.state = { expanded: false,
    ...
    // getData() {
    //     setTimeout(() => {
    //         console.log('user id is  in create coll ',this.state.getuserid)
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 2,backgroundColor:'#fff' }}>
                ...
                placeholder="Add a Title" style={{ textAlign:'left',fontSize:18,justifyContent:'center',height: 50,borderRadius:20,backgroundColor:'#F9F9F9' }} />
...
function mapStateToProps(state){
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(CreateCollectionEdit);