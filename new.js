    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv">
    ...
    <!--<header class="header">
        ...
        <div class='search-container hidden-xs'>
            ...
            <input type="checkbox" id="profile2">
                    <img src="/uploads/profile/http://pagevio.com/uploads/profile/1609915630.png" class="profile--cover">
                    <span>jochals</span>
            <label for="profile2"><i class="fa fa-sort-desc" style="font-size:24px"></i></label>
            <ul class="profile_dropmenu">
                <li>
                            <a href="#"><img src="/uploads/profile/http://pagevio.com/uploads/profile/1609915630.png" class="image--cover"></a>
               ...
               <li><a href="http://pagevio.com/collections">Collections</a></li>
                ...
                <li><a href="#">Help</a></li>
                    ...
                    <form id="logout-form" action="http://pagevio.com/logout" method="POST" style="display: none;">
                        <input type="hidden" name="_token" value="L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv">                </form>
                </li>
            </ul>
        </label>
        <ul class="menu">
    ...
    <header class="header ">
       <!-- <a href="http://pagevio.com" class="logo">Imozzo</a>  -->
        ...
        <div class='search-container hidden-xs'>
            ...
            <label for="profile2" class="profile-dropdown">
            <input type="checkbox" id="profile2">
                         <img src="http://pagevio.com/uploads/profile/1609915630.png" class="profile--cover">
                     <span id="LoginUserName">jochals</span>
            <label for="profile2"><i class="fa fa-sort-desc"></i></label>
            <ul class="profile_dropmenu">
                <li>
                                        <a  class="profile--hover"><img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover"></a>
                                </li>
                <li>
                    <label>
                        jochals<br />
          ...
          <li>
                <div class="dropdown">
                     ...
                     <span class="badge2 badge-danger" id="TotalNotification">1</span>
                      <ul class="dropdown-menu notify" role="menu" aria-labelledby="dropdownMenu1" style="margin-top: 60px;">
                        ...
                        <ul class="timeline timeline-icons timeline-sm" style="width:260px;overflow-y: auto;height: 300px;" id="notificationLoad">
                                                                  <li class="do-notify">
                             <a style="cursor:pointer" href="http://pagevio.com/notification-read/comments/6"  >
                         
                              <div class="d-flex">
                                      <div class="user-icons">
                                          <img src="http://pagevio.com/uploads/profile/1609915630.png">
                                          
                                      </div>
                                      <div class="flex-grow">
                                         <h5>jochals</h5>
                                          <p>Commented on your <b>"Episode 3"</b></p>
           ...
           <!--  <notification :userId="1" :unreads="[{&quot;id&quot;:6,&quot;type&quot;:&quot;App\\Notifications\\NotificationFeeds&quot;,&quot;notifiable_type&quot;:&quot;App\\User&quot;,&quot;notifiable_id&quot;:1,&quot;data&quot;:{&quot;id&quot;:&quot;3111&quot;,&quot;title&quot;:&quot;Episode 3&quot;,&quot;user_name&quot;:&quot;jochals&quot;,&quot;type&quot;:&quot;comments&quot;,&quot;bookimg&quot;:&quot;..\/..\/images\/no-book.jpg&quot;,&quot;user_id&quot;:1,&quot;comment&quot;:&quot;Nice&quot;,&quot;actionURL&quot;:&quot;http:\/\/pagevio.com\/notification-read\/comment&quot;,&quot;icon&quot;:&quot;fa fa-comment&quot;,&quot;heading&quot;:&quot;Commented on your&quot;},&quot;read_at&quot;:null,&quot;created_at&quot;:&quot;2021-01-11 12:45:43&quot;,&quot;updated_at&quot;:&quot;2021-01-11 12:45:43&quot;}]"></notification> -->
       ...
       if(e.keyCode==13 && $('#data').val())
        ...
        function search(e)
        {
            ...
            $.ajax({
                ...
                data: {data:val,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
      ...
      Pusher.log = function(message) {
        ...
        var html ="";
         $.ajax({
            ...
            data: {"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
    ...
    .navbar-header .profile-dropdown span {
    ...
    /*------------new integration css starts here-------------*/
    .btn{
            font-family: azoSansRegular;
    }
    .page_margin{
    ...
    .tab-active{
        border: 2px solid #27a291 !important;
    }
    .progtabs_nav td {
            border: 1px solid #707070;
        width: 130px;
    ...
    <script>
        <!--< //href="http://www.pinterest.com/pin/create/button/?url=<page url (encoded)>&media=<picture url (encoded)>&description=<HTML-encoded description>" target="_blank" class="pinterest-anchor pinterest-hidden">-->
                ...
                document.getElementById("tweet").setAttribute('href','https://twitter.com/intent/tweet?hashtags=pagevio&original_referer=http%3A%2F%2Farinos.co.uk&ref_src=twsrc%5Etfw&text=Type%20Something&tw_p=tweetbutton&url='+x+'&via=pagevio');
                document.getElementById("pinterest").setAttribute('href','http://www.pinterest.com/pin/create/button/?url='+x+'&media=https://arinos.co.uk/uploads/publication-cover/1609950795.png&description=<HTML-encoded description>');    
               // document.getElementById("embed").setAttribute('href','http://api.embed.ly/1/oembed?format=json&url='+x+'');
                document.getElementById("mail").setAttribute('href','mailto:?body='+x+'&message="check this link"&attachment="http://pagevio.arinos.co.uk/uploads/publication-cover/1609950795.png"');
                var token = '424661768217740|b7afff97e82b64eb07a15730d8c79932';
                $.ajax({
                   url: 'https://graph.facebook.com/v3.0/',
                 dataType: 'jsonp',
                 type: 'GET',
                 data: {fields:'engagement', access_token: token, id: window.location.href },
                 success: function(data){
                   console.log(data);
                $('#results').html(data.engagement.share_count);
                 }
                 });
    ...
    <div class="progress">
        <div class="bar">
           ...
           <nav class="navbar" style="position:inherit;">
                <div class="container-fluid" style="position: inherit;width: 100%;">
                    <div class="navbar-header">
                                            <label class="profile-dropdown" style="float:left;cursor:default;background:transparent;">
                           <a href="http://pagevio.com/publication-cover-description/159"><img src="http://pagevio.com/uploads/publication-cover/1609950795.png" class="title--cover"></a>
                            <span>Test for Quick insert</span>
                        </label>
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <div class="expand-search">
                                ...
                                <a id="btnSearch" class="btn-search"><img src="http://pagevio.com/assets/images/icons/search.png"/></a>
                            </div>
                        </li>
    
                        <li>
                            <select name="color" id="color" class="justselect">
                                <option>Content</option>
                                                                                           <option value="http://pagevio.com/publication-page-text/159?pages=1" selected><a href="">Testing for Image</a></option>
                                                                                            <option value="http://pagevio.com/publication-page-text/159?pages=2" ><a href="">Testing for Audio </a></option>
                                                                                            <option value="http://pagevio.com/publication-page-text/159?pages=3" ><a href="">Testing for quotes</a></option>
                                                                                            <option value="http://pagevio.com/publication-page-text/159?pages=4" ><a href="">Testing for Sub heading</a></option>
                                                                                            <option value="http://pagevio.com/publication-page-text/159?pages=5" ><a href="">Testing for Separator</a></option>
                                                                                      </select>
                        </li>
                        <li class="hidden-xs"><i class="fa fa-angle-up" id="drop-arrow" style="font-size:36px;margin: 4px 32px 4px 42px;cursor:pointer;color:#909090"></i></li>
        ...
        <div class="container feature-container">
                ...
                <div class="page-window">
                    <div class="pin-chapter-title">
                        <h2 id="maintitle" class="chapter-title"> <div><p contenteditable="true" placeholder="Title...">Testing for Image</p></div></h2>
                    </div>
                                    <div class="chapter-content fr-element fr-view">
                          <p>A <strong>computer</strong> is a <a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p><p><br></p><p><span class="fr-img-caption fr-fic fr-dib fr-draggable" contenteditable="false" draggable="false" style="width: 538px;"><span class="fr-img-wrap" onclick="shwimgtoolnew(1,this,event)"><img src="/uploads/stories/1609950854.jpg" id="Image_1" class="fr-draggable" onclick="myFunction(event)"><code class="imageToolbar" contenteditable="false" id="Imgcaptool_1" style="display: none; right: unset; bottom: 87px; left: unset;"><i onclick="ImgCapProp('B',event)" class="fa fa-bold" aria-hidden="true"></i><i onclick="ImgCapProp('I',event)" class="fa fa-italic" aria-hidden="true"></i><i class="fa fa-link" aria-hidden="true"></i><i class="fa fa-caret-up" onclick="ImgCapProp('up',event)" aria-hidden="true"></i><i class="fa fa-caret-down" onclick="ImgCapProp('down',event)" aria-hidden="true"></i><i class="fa fa-superscript" aria-hidden="true"></i><i class="fa fa-subscript" aria-hidden="true"></i><i class="fa fa-square" onclick="ImgCapProp('overlay',event)" aria-hidden="true"></i></code><span class="capoverlay" contenteditable="false" style="text-align: left; bottom: 5px; left: unset; top: unset; background-color: rgb(254, 254, 254); font-weight: bold; font-style: italic;"><input id="imgcapinp1_1" type="text" style="margin-right:100px;background:transparent;font-size:15px;" class="subtitle" placeholder="Caption(optional)" value="test " onkeydown="Edit2BackspaceInp(this,event)"><input id="imgcapinp2_1" style="margin-right:100px;background:transparent;font-size:13px;" class="subtitle" placeholder="Image Credits(optional)" value="test caption" onkeydown="Edit2BackspaceInp(this,event)"></span></span></span></p><p>A <strong>computer</strong> is a <a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p><p>A <strong>computer</strong> is a <a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p><p>A <strong>computer</strong> is a <a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p><p>A <strong>computer</strong> is a <a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p><p>A&nbsp;<strong>computer</strong> is a&nbsp;<a href="https://simple.wikipedia.org/wiki/Machine" title="Machine">machine</a> that accepts data as input, processes that data using programs, and outputs the processed data as information. Many computers can store and retrieve information using hard drives. Computers can be connected together to form networks, allowing connected computers to communicate with each other.</p>
                ...
                <div class="col-md-10">
                    <div class="col-md-6">
                        ...
                        <a href="http://pagevio.com/publication-page-text/159?pages=2">
                        <p class="pre-nxt">Next</p>
                        <p class="nav-chapter">Testing for Audio </p></a>
                                    </div>
                </div>
                <div class="col-md-1"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="cards-list follow follow-padding">
                        ...
                        <li class="card card-comment card--small">
                            <figure class="card-figure">
                               <a href="http://pagevio.com/author-profile/1"> <img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover m-0"></a>
                            </figure>
                    ...
                    <div class="marg-bottom follow-padding">
                        ...
                        <button class="btn like_tab" id="like_button" data-id="3284" >
                            <img src="http://pagevio.com/assets/images/help/like.png" id="white_like1" alt="My Pic" > <span id="page_like"> 0</span>
                        </button>
    
                         <button class="btn like_tab" id="unlike_button" data-id="3284" style="background-color: #27A291;color: #fff">
                            <img src="http://pagevio.com/assets/images/help/white-like.png" id="like1" alt="My Pic">
                            <span id="page_unlike"> 0</span>
                        </button>
                        ...
                        <span class="dropdown">
                                ...
                                <span class="popuptext1 dropdown-menu">
                                    <ul id="move_publication" class="list-group add-roll"   >
                                                                          <li class="list-group-item add-hover SaveToCollection"  data-id="343+collection-pages+4" data-page-id="3284">
                                          ...
                                          <!--   <input type="submit" id="arrow" onclick="chooseSection()" class="fa form-control" value="&#xf105;"> -->New private</li>
                        ...
                        <span class="dropup">
                           ...
                           <script>!function(a){var b="embedly-platform",c="script";if(!a.getElementById(b)){var d=a.createElement(c);d.id=b,d.src=("https:"===document.location.protocol?"https":"http")+"://cdn.embedly.com/widgets/platform.js";var e=document.getElementsByTagName(c)[0];e.parentNode.insertBefore(d,e)}}(document);</script>
                                    ...
                                    <!--<iframe id="test" src="" width="83" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>-->
                                            <a id="fb" href="" target="_blank" class="share_icons" onclick="sharecount('fb')" ><img class="icon-margin" src="http://pagevio.com/assets/flat-icons/facebook.png" alt="" width="" height=""></a>
                                            <a id="tweet" href="" target="_blank" class="share_icons" onclick="sharecount('tweet')"><img class="icon-margin" src="http://pagevio.com/assets/flat-icons/twitter.png" alt="" width="" height=""></a>
                                            <img class="icon-margin share_icons" onclick="sharecount('insta')" src="http://pagevio.com/assets/flat-icons/instagram.png" alt="" width="" height="">
                                            <a id="pinterest" class="share_icons" onclick="sharecount('pinterest')" href="" target="_blank"><img class="icon-margin" src="http://pagevio.com/assets/flat-icons/pinterest.png" alt="" width="" height=""></a>
                                            <a id="tumblr" class="share_icons" onclick="sharecount('tumblr')" href="https://www.tumblr.com/widgets/share/tool?posttype=link&title=PageVio%20-%20Publication%20Cover%20Description&content=https%3A%2F%2Farinos.co.uk%2Fpublication-cover-description%2F270&canonicalUrl=https%3A%2F%2Farinos.co.uk%2Fpublication-cover-description%2F270&shareSource=tumblr_share_button" target="_blank"><img class="icon-margin" src="http://pagevio.com/assets/flat-icons/tumblr.png" alt="" width="" height=""></a>
                        ...
                        <img src="http://pagevio.com/assets/images/help/flag.png" alt="Report"> 
                            <img src="http://pagevio.com/assets/images/icons/c_flag.png" alt="Report" > Report</button>
                ...
                <div class="col-md-6">
                    <div class="pin-chapter-title">
                        <h2 class="chapter-title"><div><p contenteditable="true" placeholder="Title..." style="text-align: center;"><b>Testing for Audio&nbsp;</b></p></div></h2>
                    </div>
                   <!-- <div class="chapter-content ">
                        <p style="text-align: justify;">You will rejoice to hear that no disaster has accompanied the commencement of an enterprise which you have regarded with such evil forebodings .I arrived here yesterday, and my first task is to assure my dear sister of my welfare and increasing confidence in the success of my undertaking.</p><div class="vidfoc" contenteditable="false" id="AudioPlayer_1" style="text-align: right;"><img src="../../images/cancel.png" alt="" style="cursor: pointer;" class="fr-draggable"><p id="audloading" style="text-align:center;"><img src="../../images/audgif3.gif" class="fr-draggable fr-fic fr-dii"></p><audio id="Audio_1"><source></audio></div><p style="text-align: justify;"><strong>I am already far north of London, and as I walk in the streets of Petersburgh, I feel a cold northern breeze play upon my cheeks, which braces my nerves and fills me with delight. Do you understand this feeling? This breeze, which has travelled from the regions towards which I am advancing, gi...
            ...
            var SelectionSharer = function (options) {
                ...
                this.render = function () {
                    var popoverHTML = '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                                     ...
                                     + '    <ul>'
                                   + '      <li><a class="action bookmark" style="cursor:pointer"  onclick="Bookmarktool()" title="Bookmark this content">Tweet</a></li>'
                                     + '      <li><a class="action pin" style="cursor:pointer" onclick="Pintool()" title="Pin this content">Tweet</a></li>'
                                     ...
                                     +'<span id="popup-hide2-1" style="left:0%;margin-top:31px;" class="popup-open commonpopup-hide-2 popuptext1 dropdown-menu dropdown-menu-add align-right popup-hide-2">'
                                              ...
                                              +'<li class="list-group-item add-hover" style="background:white;color:#27A291;cursor:auto;width:200px;font-size:15px;">Choose Collection</li>'
                                                                                        +'<li  class="list-group-item add-hover" style="border:1px solid white;text-align:left;" onclick="SaveToCollectionSection(this)" data-id="0+343+3284"><span>New private</span>&nbsp;&nbsp'
                                              +'<i style="font-size: 16px;padding-top: 4px;margin-left: 10px;"  class="fa fa-globe"></i>&nbsp'
                                                                                         +'<i onClick="Get_collection_section(event,1,343,3284)" style="font-size:20px;" class="fa fa-angle-right"></i>'
                                                                                         +'</li>'
                                                                                      +'</ul>'
                                            ...
                                            +'<div onclick="window.event.stopPropagation();" id="demo-1" style="padding:0 10px;border-top: 1px solid #707070;" class="collapse">'
                                                ...
                                                +'<input type="hidden" id="collection-data-1" value="3284" />'
                                            ...
                                            +'<div class="dropdown" id="create-colection-1">'
                                                +'<div  data-toggle="dropdown" style="text-align:center;background: #27a291 !important;color:white;cursor:pointer;padding-top:10px;padding-left:0px;" class="add-item add-hover dropdown-toggle" type="button" onclick="NewCollectionbox(3284)" onclick="" id="collapse-div-3284">'
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //$('#maintitle').html($('#maintitle').find('p').html());
            $('.chapter-content').find('img').each(function(){
               $(this).attr('src') =="../../images/cancel.png" ? $(this).hide() : ""
            });
          ...
          // $('input').attr('readonly','readonly');
           $('.chapter-content input').each(function(){
              ...
              $('audio').each(function(){
                   $(this).ModaudioPlayer();
                   $(this).parent().parent().find('input')[0].addEventListener('keydown',()=>Edit2BackspaceInp($(this).parent().parent().find('input')[0],event));
               });
             ShowBookmark();
             sharefunctions();
        });
    ...
    function sharecount(type)
        {
            $.ajax({
               type:'post',
               url:"http://pagevio.com/post-share",
               data:{post_id:0,page_id:"3284",post_type:4,author_id:"1",share_type:type,'_token':"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
               success:function(result)
               {
        ...
        $('#leave-comment').click(function () {
            $('.content-whatsapp-bottom').toggle();
        });
    ...
    <script>
        ...
        $('body').on('click', function (e) {
           ...
           /* document.getElementById("list-item").style.height = "165px";*/
            document.getElementById("collapse-div").style.textAlign = "center"
            document.getElementById("collapse-image").style.display = "inline";
            document.getElementById("collapse-text").innerHTML = "Create New Collection";
        });
          ...
          <script>
                ...
                for (i = 0; i < x.length; i++) {
                  ...
                  a.addEventListener("click", function(e) {
                      ...
                      document.getElementsByClassName("select-selected").style.color = "#27A291"
                    });
                }
        ...
        <script type="text/javascript">
         ...
         $('#follow').click(function (){
            ...
            $.ajax({
                ...
                data: {user_id:user_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){ 
        
                if (data == 'success') {
                    $('.alert-container').removeClass("alert-container-error")
                    $('#msg').html("<strong>Followed Successfully</strong>");
            ...
            $('#unfollow').click(function (e){
             ...
             $.ajax({
                ...
                if (data == 'success') {
                    $('.alert-container').removeClass("alert-container-error")
                     $('#follow').show();
                    $('#msg').html("<strong>Unfollowed Successfully</strong>");
                    $(".alert-container").addClass("alert-container-error");
                    $('.alert-container').show();
        ...
        $(document).ready(function () {
           $('.chapter-content').find('input').attr('readonly','readonly');
            ...
            $.ajax({
                ...
                data:{post_id:"3284",location:location,from:"3284",description:description,type:'event',len:dates.length,title:title,startdate:startdate,endate:enddate,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success:function(result){
    ...
    //like
        $('#like_button').click(function(){
            ...
            $.ajax({
                ...
                data: {page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){
    ...
    if(ongoingcomment)
        ...
        $('.send-msPopup').css('cursor','wait');
         ...
         $.ajax({
            ...
            data: {page_id:page_id,msg:msg,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success: function(data){
    ...
    $('.CommentClick').click(function(){
          ...
          var comment='<li class="card card-comment  card--small"><figure class="card-figure"><img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover"></figure><div class="card-content"><div class="content-whatsapp-bottom"><input style=" border: 1px solid #27A291;" class="whats-input comment2" type="text"  placeholder="Leave a comment..." /><img class="send-msPopup" onclick="commentSend()" src="http://pagevio.com/assets/images/help/send.png" alt="My Pic"></div></div></li>';
             ...
             if (data.status == 'success') {
                ...
                data.result.forEach(function(item, index){    
                  ...
                  else
                  {
                      ...
                      {
                          ++count;
                      comment +='<li class="card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="http://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.orgin+'/'+item.avatar+'" class="image--cover"></a></figure><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" id="CommentReply'+item.id+'" type="text"  placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                      else
                      {
    ...
    function commentSend(parentId,opt,ids)
    {
        ...
        $('.send-msPopup').css('cursor','wait');
         ...
         $.ajax({
            type: "post",
            url: "http://pagevio.com/page-comment",
            data: {page_id:page_id,msg:msg,parentId:parentId,opt:opt,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success: function(data){
    ...
    function commentReload()
    {
         var page_id = "3284";
          ...
          var comment='<li class="card card-comment  card--small"><figure class="card-figure"><img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover"></figure><div class="card-content"><div class="content-whatsapp-bottom"><input class="whats-input comment2" type="text" placeholder="Leave a comment..." /><img class="send-msPopup" onclick="commentSend()" src="http://pagevio.com/assets/images/help/send.png" alt="My Pic"></div></div></li>';
             ...
             if (data.status == 'success') {
                ...
                data.result.forEach(function(item, index){    
                  ...
                  else
                  {
                      ...
                      {
                          ++count;
                      comment +='<li class="card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="http://pagevio.com/author-profile/'+item.user_id+'"><img src="'+item.avatar+'" class="image--cover"></a></figure><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2"  id="CommentReply'+item.id+'" type="text" placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                      else
                      {
                       comment +='<li style="padding-left:'+replypadding+'px;" class="card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="http://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.orgin+'/'+item.avatar+'" class="image--cover"></a></figure><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" value="@'+item.username+'" id="CommentReply'+item.id+'" type="text" placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
         ...
         $(".SaveToCollection").click(function () { 
            ...
            var alert = $(".alert-container");
                $.ajax({
                    ...
                    data: {id:result[0],type:result[1],type_id:result[2],page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                    success: function(data){ 
         ...
         $('#create-collection').click(function(){
             ...
             if (name == '') {
              ...
              $.ajax({
                  ...
                  data: {title:name,privacy:privacy,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                  success: function(data){ 
    ...
    function Bookmarktool()
           ...
           $('#msg').html("<span>Bookmark Added</span>&nbsp;&nbsp;<u style='cursor:pointer' onclick='bookmarkundo()'>undo</u>") &&
                        ...
                        window.setTimeout(function () {
                            ...
                            if(bookundo==0)
                            {
                             ...
                             data:{page_id:page_id,type:'select',data:selectedtext,line_number:line_number,selected_text:1,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                             success:function(data)
                             {
                             if(data.status=='success')
                              {
         ...
         function AddBookmark(img)
         {
                        ...
                        window.setTimeout(function () {
                            ...
                            if(bookundo==0)
                            {
                             $.ajax({
                              type:'post',
                                url:"http://pagevio.com/add-bookmark",
                              data:{page_id:page_id,type:'page',data:data,line_number:ln,selected_text:0,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                              success:function(data)
                              {
                               if(data.status=='success')
                               {
             ...
             window.setTimeout(function () {
                 ...
                 data:{id:id,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                 success:function(result)
                 {
                     img.src="http://pagevio.com/assets/images/icons/white_bookmark.png";
                     if(result.status=='success')
            ...
            var bookmarks=[];
             ...
             for(var iteration=0;iteration<bookmarks.length;iteration++)
             {
                 ...
                 $('.selectionShareable').each(function(i,val){
                    ...
                    if((!(str.search(l)==-1) || (str.length==l.length)) && (i+1==bookmarks[iteration].line_number) && (bookmarks[iteration].selected_text==0))
                    {
                        var v=$(this).find('img');
         ...
         function changefilter(get)
         {
             var value=get.getAttribute('data-value');
             if(!(value=='Content'))
             {
        ...
        $.ajax({
            ...
            data:{authorid:"1",pageid:"3284",type:'page',reason:reason,ReportAdditional:ReportAdditional,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success:function(data){
                if(data.status=="success"){
                $('#myModal2').modal('show');
                }
            ...
            function CreateCollection()
           {
            ...
            //var datastring = $("#frm").serialize();
                ...
                $.ajax({
                    ...
                    data: {title:title,privacy:privacy,description:description,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                    cache: false,
                    success: function(data){
                        if (data.status == "success") {
                           $.ajax({
                           ...
                           data: {page_id:page_id,type:'2',collection_id:data.id,section_id:0,Description:selectedtext,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                           success: function(data){ 
                           console.log(data);
            ...
            {
                             var datas="[{&quot;section_id&quot;:215,&quot;collection_id&quot;:18,&quot;user_id&quot;:10,&quot;title&quot;:&quot;the box car&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:&quot;We can now find the box car&quot;,&quot;created_at&quot;:&quot;2020-12-03 03:36:00&quot;,&quot;updated_at&quot;:&quot;2020-12-03 08:36:00&quot;},{&quot;section_id&quot;:224,&quot;collection_id&quot;:222,&quot;user_id&quot;:1,&quot;title&quot;:&quot;Sea section1&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:null,&quot;created_at&quot;:&quot;2020-12-07 05:45:05&quot;,&quot;updated_at&quot;:&quot;-0001-11-30 00:00:00&quot;},{&quot;section_id&quot;:301,&quot;collection_id&quot;:343,&quot;user_id&quot;:1,&quot;title&quot;:&quot;New&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:null,&quot;created_at&quot;:&quot;2021-01-11 08:11:11&quot;,&quot;updated_at&quot;:&quot;2020-12-23 20:51:17&quot;},{&quot;section_id&quot;:355,&quot;collection_id&quot;:343,&quot;user_id&quot;:1,&quot;title&quot;:&quot;1&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:null,&quot;created_at&quot;:&quot;2021-01-11 08:11:11&quot;,&quot;updated_at&quot;:&quot;-0001-11-30 00:00:00&quot;},{&quot;section_id&quot;:356,&quot;collection_id&quot;:343,&quot;user_id&quot;:1,&quot;title&quot;:&quot;1&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:null,&quot;created_at&quot;:&quot;2021-01-11 08:11:11&quot;,&quot;updated_at&quot;:&quot;-0001-11-30 00:00:00&quot;},{&quot;section_id&quot;:369,&quot;collection_id&quot;:341,&quot;user_id&quot;:13,&quot;title&quot;:&quot;New marvel section&quot;,&quot;privacy&quot;:&quot;Public&quot;,&quot;description&quot;:&quot; Jvjf&quot;,&quot;created_at&quot;:&quot;2021-01-08 05:19:07&quot;,&quot;updated_at&quot;:&quot;-0001-11-30 00:00:00&quot;}]";
            ...
            function SaveToCollectionSection(elem)
            {
                ...
                data=data.split('+');
                           ...
                           type: "post",
                           url: "http://pagevio.com/save-to-pins",
                           data: {page_id:data[2],type:'2',collection_id:data[1],section_id:data[0],Description:selectedtext,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                           success: function(data){ 
                           console.log(data);
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
       ...
       <!--  <script src="https://pagevio.com/js/app.js"></script> -->
    
        <!-- Fonts -->
        <link rel="dns-prefetch" href="//fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://pagevio.com/assets/web/css/responsive2.css" />
        
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <!-- Styles
        <link href="https://pagevio.com/css/app.css" rel="stylesheet"> -->
    </head>
    <!DOCTYPE html>
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="icon" href="https://pagevio.com/assets/images/icons/favi.png" type="image/gif" sizes="16x16">
    
        <!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.98.0/css/materialize.min.css"/>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.1/js/materialize.min.js"></script>-->
        <link rel="stylesheet" href="https://pagevio.com/assets/web/css/selectbox.min.css" />
        <link rel="stylesheet" href="https://pagevio.com/assets/web/css/custom.css" />
      <!--   <link rel="stylesheet" href="https://pagevio.com/assets/web/css/custom-styles.css" /> -->
      <meta name="csrf-token" content="L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv">
    ...
    <!--<header class="header">
        <a href="https://pagevio.com" class="logo">Imozzo</a>
        <input class="menu-btn" type="checkbox" id="menu-btn" />
        <label class="menu-icon" for="menu-btn"><span class="navicon"></span></label>
        <div class='search-container hidden-xs'>
            <div class='search-area'>
                <input class='community-search' type="text" placeholder="Search by Title or Author" onclick="window.location.href='https://pagevio.com/search'"/>
                <i class="fa fa-search"></i>
            </div>
        </div>
            ...
            <ul class="profile_dropmenu">
                ...
                <li>
                    <label style="text-align:center;display:block;">
                        <a href="https://pagevio.com/profile" class="view">View Profile</a>
                    </label>
                </li>
               <li><a href="https://pagevio.com/collections">Collections</a></li>
                <li><a href="https://pagevio.com/readlater">Read Later</a></li>
                <li><a href="https://pagevio.com/reminder">Reminders</a></li>
                <li><a href="https://pagevio.com/notification">Notifications</a></li>
                <li><a href="https://pagevio.com/following">Following</a></li>
                <li><a href="https://pagevio.com/settings">Settings</a></li>
                <li><a href="#">Help</a></li>
                            <li>
                    <a class="dropdown-item" href="https://pagevio.com/logout" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();">
                        Logout
                    </a>
                    <form id="logout-form" action="https://pagevio.com/logout" method="POST" style="display: none;">
                        <input type="hidden" name="_token" value="L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv">                </form>
                </li>
            </ul>
        </label>
                ...
                <div class="dropdown">            
                    ...
                    <div class="dropdown-menu browse create" style="width: 180px;">
                        <ul class="row" style="overflow: visible;">
                            ...
                            <li class="col-md-4" style="width: 100% !important;"><a href="https://pagevio.com/create-periodical">Create Periodical</a></li>
                            <li class="col-md-4" style="width: 100% !important;"><a href="https://pagevio.com/create-publication">Create Publication</a> </li>
                            <li class="col-md-4" style="width: 100% !important;"><a href="https://pagevio.com/create-series">Create Series</a></li>                      
                        </ul>
                    </div>
                </div>
            </li>
                   <li><a href="https://pagevio.com/bookmark"><i class="fa fa-bookmark" style="font-size:20px" title="bookmarks"></i></a></li>
            <li><a href="https://pagevio.com/newsfeed"><i class="fa fa-rss" style="font-size:20px" title="newsfeed"></i></a></li>
        </ul>
    ...
    <header class="header ">
       <!-- <a href="https://pagevio.com" class="logo">Imozzo</a>  -->
        <a href="https://pagevio.com" class="logo" style="padding: 14px;padding-right: 40px;">
            <img src="https://pagevio.com/assets/images/icons/new_logo.png" style="width:110px;" class="hidden-xs"/>
             <img src="https://pagevio.com/assets/images/icons/favi.png" style="width:40px;" class="hidden-lg hidden-md hidden-sm"/>
            </a>  
        <input class="menu-btn" type="checkbox" id="menu-btn" />
        <label class="menu-icon" for="menu-btn"><span class="navicon"></span></label>
        <div class='search-container hidden-xs'>
            <div class='search-area'>
                <input class='community-search' type="text" id="data" placeholder="Search by Title or Author" />
                <img src="https://pagevio.com/assets/images/icons/search.png" onclick="search(this)" />
            </div>
        </div>
            <label for="profile2" class="profile-dropdown">
            <input type="checkbox" id="profile2">
            ...
            <ul class="profile_dropmenu">
                ...
                <li><a href="https://pagevio.com/readlater">Read Later</a></li>
                <li><a href="https://pagevio.com/reminder">Reminders</a></li>
                <li><a href="https://pagevio.com/notification/follow">Notifications</a></li>
                <li><a href="https://pagevio.com/following">Following</a></li>
                <li><a href="https://pagevio.com/summary/pages">Summary</a></li>
                <li><a href="https://pagevio.com/settings">Settings</a></li>
                <li><a href="https://pagevio.com/help">Help</a></li>
                                        <li>
                    <a class="dropdown-item" href="https://pagevio.com/logout" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();">
                        Logout
          ...
          <li>
                <div class="dropdown">
                      <a href="#" class="dropdown swap" role="button" data-toggle="dropdown" style="float: left" aria-expanded="true">
                       <!-- <i class="fa fa-bell-o p-0" style="font-size: 20px; float: left; color: black">-->
                          <img id="notify" src="https://pagevio.com/assets/images/icons/notify.png" title="notification">
                        <img id="c_notify" src="https://pagevio.com/assets/images/icons/c_notify.png" title="notification"> 
                        </i>
                      </a>
                     <span class="badge2 badge-danger" id="TotalNotification">1</span>
                      <ul class="dropdown-menu notify" role="menu" aria-labelledby="dropdownMenu1" style="margin-top: 60px;">
                        ...
                        <ul class="timeline timeline-icons timeline-sm" style="width:260px;overflow-y: auto;height: 300px;" id="notificationLoad">
                                                                  <li class="do-notify">
                             <a style="cursor:pointer" href="https://pagevio.com/notification-read/comments/6"  >
                                      ...
                                      <div class="flex-grow">
                                         <h5>jochals</h5>
                                          <p>Commented on your <b>"Episode 3"</b></p>
                                                                        ...
                                                                        <div class="post-icons">
                                          <img src="https://pagevio.com/../../images/no-book.jpg">
                                      </div>
                                                                    </div>
        ...
        <ul class="menu">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle swap" data-toggle="dropdown">
              <img src="https://pagevio.com/assets/images/icons/write.png" title="create">
                    <img src="https://pagevio.com/assets/images/icons/write_hover.png" title="create">
            </a>
                    <div class="dropdown-menu browse create">
                        <ul class="row" style="overflow: visible;">
                            <li class="col-md-4 create-dropdown"><a href="https://pagevio.com/create-page">Create Page</a></li>
                            <!--<li class="col-md-4 create-dropdown"><a href="https://pagevio.com/create-series">Create Series</a></li>
                            <li class="col-md-4 create-dropdown"><a href="https://pagevio.com/create-periodical">Create Periodical</a></li>-->
                            <li class="col-md-4 create-dropdown"><a href="https://pagevio.com/create-publication">Create Publication</a> </li>
                           <!-- <li class="col-md-4 create-dropdown"><a href="https://pagevio.com/summary/pages">Summary</a></li>-->
                           <!-- <li class="col-md-4 create-dropdown"><a href="https://pagevio.com/summary/pages">Create Post</a></li>-->
                        </ul>
                    </div>
                </div>
            </li>
        ...
        <a href="https://pagevio.com/bookmark" class="swap">
          <img id="book" src="https://pagevio.com/assets/images/icons/bookmark.png" onclick="$('#book').css('display','none');$('#c_book').css('display','block')" title="bookmarks">
              <img id="c_book" src="https://pagevio.com/assets/images/icons/c_bookmark.png"  title="bookmarks">
        </a>
        </li>
            <li>
        <a href="https://pagevio.com/newsfeed" class="swap">
                    <img id="newsfeed" src="https://pagevio.com/assets/images/icons/newsfeed.png" title="newsfeed">
                   <img id="c_newsfeed" src="https://pagevio.com/assets/images/help/green-newsfeed.png" title="newsfeed"> 
        </a>
        </li>
    ...
    $('body').keydown(function(e){
       if(e.keyCode==13 && $('#data').val())
        ...
        function search(e)
        {
            ...
            $.ajax({
                type: "post",
                url: "https://pagevio.com/search-session",
                data: {data:val,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){ 
                console.log(data);
                    if (data == 'success') {
                      window.location.href="https://pagevio.com/search";
                    }     
                } 
            });
        }
      ...
      Pusher.log = function(message) {
        ...
        var html ="";
         $.ajax({
            type: "post",
            url: "https://pagevio.com/get-notification",
            data: {"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success: function(response){
             var data = JSON.parse(response);
             if (data.status == 'success') {
      ...
      function notification(type,ids)
          { 
              //alert(type);
              var url1="https://pagevio.com/notification-read/type1/ids1";
              url1=url1.replace('type1',type);
              url1=url1.replace('ids1',ids);
              $.ajax({
                 type:'post',
            ...
            //var url="https://pagevio.com/notification/type";
            //url=url.replace('type',type);
            //window.location.href=url;
          }
      </script>    <body>
        ...
        <!--     <div class="row pagination-bar">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-10">
                    <ul class="cards-list follow follow-padding">
                        ...
                        <li class="card card-comment card--small">
                            <figure class="card-figure">
                                                                     <img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover m-0">
                                                        </figure>
                            <div class="card-content m-0">
                                                        <a href="https://pagevio.com/author-profile/1"><h4>jochals</h4></a>
                    ...
                    <div class="marg-bottom follow-padding">
                        ...
                        <button class="btn like_tab" id="like_button" data-id="3298" >
                            <img src="https://pagevio.com/assets/images/help/like.png" id="white_like1" alt="My Pic" > <span id="page_like"> 1</span>
                        </button>
    
                         <button class="btn like_tab" id="unlike_button" data-id="3298" style="background-color: #24d4bc;color: #fff;display:none">
                            <img src="https://pagevio.com/assets/images/help/white-like.png" id="like1" alt="My Pic">
                            <span id="page_unlike"> 1</span>
                        </button>
    
                        <!-- button for comment option          -->
    
                        <button id="example-popover" onfocus="message_button1()" onfocusout="message_buttonOut1()" tabindex="0" data-trigger="click" role="button" data-placement="bottom" class="btn btn-cmt CommentClick" >
                            <img src="https://pagevio.com/assets/images/help/message.png" id="message1" alt="My Pic">
                            <img src="https://pagevio.com/assets/images/help/white-message.png" id="white_message1" alt="My Pic" class="display-none"><span id="total-comment">0</span>
                        </button>
                       ...
                       <span class="dropdown">
                                <button class="btn dropdown-toggle comment-btn" onfocus="add_button1()" onfocusout="add_buttonOut1()" data-toggle="dropdown">
                                    <img src="https://pagevio.com/assets/images/help/add.png" id="add1" alt="My Pic">
                                    <img src="https://pagevio.com/assets/images/help/white-add.png" id="white_add1" alt="My Pic" class="display-none">
                                    add
                                </button>
                                <span class="popuptext1 dropdown-menu">
                                    <ul id="move_publication" class="list-group add-roll"   >
                                                                          <li class="list-group-item add-hover SaveToCollection"  data-id="343+collection-pages+4" data-page-id="3298">
                                                                                     <i style="font-size: 16px;padding-top: 4px;margin-left: 10px;" class="fa fa-ban"></i>&nbsp;
                                                                                          <!--<i class="fa fa-angle-right" style="float:right" onclick="chooseSection()"></i>-->
                                    ...
                                    <div onclick="collapse()" id="collapse-div" class="add-item add-hover collapse-div" type="button" data-toggle="collapse" data-target="#demo"><img id="collapse-image" src="https://pagevio.com/assets/images/help/white-add.png" ><span id="collapse-text">Create New Collection</span>
                                    </div>
                                  
                                    <div id="create-collection" class="add-item add-hover collapse-div " type="button" data-toggle="collapse" data-target="#demo" style="text-align: center;display: none;"><img id="collapse-image" src="https://pagevio.com/assets/images/help/white-add.png" style="display: none;"><span id="collapse-text">Create</span>
                                    </div>
                        ...
                        <span class="dropup">
                            <button class="btn dropdown-toggle comment-btn" onfocus="share_button1()" onfocusout="share_buttonOut1()" data-toggle="dropdown">
                                <img src="https://pagevio.com/assets/images/help/share.png" id="share1" alt="My Pic">
                                <img src="https://pagevio.com/assets/images/help/white-share.png" id="white_share1" alt="My Pic" class="display-none">
                                Share
                            </button>
                            <script>!function(a){var b="embedly-platform",c="script";if(!a.getElementById(b)){var d=a.createElement(c);d.id=b,d.src=("https:"===document.location.protocol?"https":"http")+"://cdn.embedly.com/widgets/platform.js";var e=document.getElementsByTagName(c)[0];e.parentNode.insertBefore(d,e)}}(document);</script>
                                    ...
                                    <!--<iframe id="test" src="" width="83" height="28" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>-->
                                            ...
                                            <a id="fb" href="" target="_blank" ><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/facebook.png" alt="" width="" height=""></a>
                                            <a id="tweet" href="" target="_blank"><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/twitter.png" alt="" width="" height=""></a>
                                            <img class="icon-margin" src="https://pagevio.com/assets/flat-icons/instagram.png" alt="" width="" height="">
                                            <a id="pinterest" href="" target="_blank"><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/pinterest.png" alt="" width="" height=""></a>
                                            <a id="tumblr" href="" target="_blank"><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/tumblr.png" alt="" width="" height=""></a>
                                            <a id="embedly" onclick="newfunc()" ><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/g_code.png" alt="" width="" height=""></a>
                                            <div style="display:none !important"> 
                                            <a class="embedly-button" href="http://embed.ly/code" data-lang="en"><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/g_code.png" alt="" width="" height=""></a>
                                            </div>
                                            <a id="mail" class="share-email" href=""><img class="icon-margin" src="https://pagevio.com/assets/flat-icons/g_mail.png" alt="" width="" height=""></a>
                                        </span>
                        </span>
                        ...
                        <button class="btn-final swap" data-toggle="modal" data-target="#myModal">
                <img src="https://pagevio.com/assets/images/help/flag.png" alt="Report">
                           <img src="https://pagevio.com/assets/images/icons/c_flag.png" alt="Report">
              Report</button>
                    ...
                    <div class="content-whatsapp-bottom follow-padding">
                        ...
                        <img class="send-msPopup" src="https://pagevio.com/assets/images/help/send.png" alt="My Pic">
             ...
             <div class="main">
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3321">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/img (7)-mini.jpg" >
                  </div>
    
                            <div class="card card--small">
                                <div class="card-content">
                                     <h4>Testing Title</h4>
                                     <p><a href="https://pagevio.com/author-profile/13">Mukeshvb</a></p>
                                     <p>Jan 12, 2021</p>
                                </div>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3298">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/310px-seek=116-Big_Buck_Bunny_4K.webm.jpg" >
                  </div>
    
                            <div class="card card--small">
                                <div class="card-content">
                                     <h4>Testing for quick insert</h4>
                                     <p><a href="https://pagevio.com/author-profile/1">jochals</a></p>
                                     <p>Jan 12, 2021</p>
                                </div>
                                 <span class="button-group inline-block relative pull-right">
                                    <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3296">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/images/no-book.jpg" >
                  </div>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3293">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/login-logo.png" >
                  </div>
    
                            <div class="card card--small">
                                <div class="card-content">
                                     <h4>Your Ultimate Guide to PageVio</h4>
                                     <p><a href="https://pagevio.com/author-profile/4">superadmin</a></p>
                                     <p>Jan 7, 2021</p>
                                </div>
                                 <span class="button-group inline-block relative pull-right">
                                    <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3287">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/maxresdefault.jpg" >
                  </div>
    
                            <div class="card card--small">
                                <div class="card-content">
                                     <h4>Passengers</h4>
                                     <p><a href="https://pagevio.com/author-profile/20">bharti</a></p>
                                     <p>Jan 7, 2021</p>
                                </div>
                                 <span class="button-group inline-block relative pull-right">
                                    <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3283">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/maserati-granturismo-2018-4k_1539105543.jpg" >
                  </div>
                                ...
                                <div class="card-content">
                                 ...
                                 <span class="button-group inline-block relative pull-right">
                                   ...
                                   <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="3283+pages+4">
                                            <span role="button" >
                                            <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                            Save to Read Later
                                            </span>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3273">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/images/no-book.jpg" >
                  </div>
                    ...
                    testing title image an</h4>
                                 ...
                                 <span class="button-group inline-block relative pull-right">
                                   ...
                                   <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="3273+pages+4">
                                            <span role="button" >
                                            <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                            Save to Read Later
                                            </span>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3272">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/310px-seek=116-Big_Buck_Bunny_4K.webm.jpg" >
                  </div>
                                ...
                                <div class="card-content">
                                 ...
                                 <span class="button-group inline-block relative pull-right">
                                   ...
                                   <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="3272+pages+4">
                                            <span role="button" >
                                            <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                            Save to Read Later
                                            </span>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3262">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/cover image.jfif" >
                  </div>
                                ...
                                <div class="card-content">
                                 ...
                                 <span class="button-group inline-block relative pull-right">
                                   ...
                                   <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="3262+pages+4">
                                            <span role="button" >
                                            <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                            Save to Read Later
                                            </span>
                    ...
                    <div class="card-article">
                        <div class="card-front" data-image-position="top">
                                          <a href="https://pagevio.com/sample-page/3261">
                  <div class="card-image card-image-top">
                    <img src="https://pagevio.com/../uploads/stories/download (1).jpg" >
                  </div>
                                ...
                                <div class="card-content">
                                 ...
                                 <span class="button-group inline-block relative pull-right">
                                   ...
                                   <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="3261+pages+4">
                                            <span role="button" >
                                            <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                            Save to Read Later
                                            </span>
            ...
            <div class="main">
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/163">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/163"></a>
                                <div class="card-content">
                                    <h4>testing discription</h4>
                                     <p><a href="https://pagevio.com/author-profile/13"></a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/162">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1610170577.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/162"></a>
                                <div class="card-content">
                                    <h4>Design</h4>
                                     <p><a href="https://pagevio.com/author-profile/29">Design</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/159">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1609950795.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/159"></a>
                                <div class="card-content">
                                    <h4>Test for Quick insert</h4>
                                     <p><a href="https://pagevio.com/author-profile/1">test</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="159+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/158">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1609734707.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/158"></a>
                                <div class="card-content">
                                    <h4>The 100</h4>
                                     <p><a href="https://pagevio.com/author-profile/13">Kass Morga</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/153">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1609155535.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/153"></a>
                                <div class="card-content">
                                    <h4>The wilds</h4>
                                     <p><a href="https://pagevio.com/author-profile/20">saraha</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="153+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/137">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/137"></a>
                                <div class="card-content">
                                    <h4>Jon snow</h4>
                                     <p><a href="https://pagevio.com/author-profile/13">Imp</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/136">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1603180102.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/136"></a>
                                <div class="card-content">
                                    <h4>12 Reasons why I love her</h4>
                                     <p><a href="https://pagevio.com/author-profile/1">jamie s ri</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="136+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/135">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1602565262.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/135"></a>
                                <div class="card-content">
                                    <h4>Read page testing</h4>
                                     <p><a href="https://pagevio.com/author-profile/13">rowling</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="135+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/133">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1602132947.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/133"></a>
                                <div class="card-content">
                                    <h4>The adventures of Huckleberry...</h4>
                                     <p><a href="https://pagevio.com/author-profile/1">MARK TWAIN</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="133+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
                    ...
                    <div class="card-article series">
                        <div class="card-front" data-image-position="top">
                             <a href="https://pagevio.com/publication-cover-description/132">
                            <div class="card-image card-image-top">
                                <img src="https://pagevio.com/uploads/publication-cover/1601292152.png">
                            </div></a>
                            <div class="card card--small">
                                 <a href="https://pagevio.com/publication-cover-description/132"></a>
                                <div class="card-content">
                                    <h4>Avengers Series</h4>
                                     <p><a href="https://pagevio.com/author-profile/1">LEE</a></p>
                                </div>
                                <span class="button-group inline-block relative pull-right">
                                   <span class="btn-no-background dropdown-toggle" data-toggle="dropdown" aria-controls="comment-more-options" aria-expanded="false" aria-label="more options">
                                        <span class="fa fa-more" aria-hidden="true" style="font-size:16px;cursor:pointer;padding-top:10px;"></span>
                                    ...
                                    <ul class="dropdown-menu align-right">
                                        <li class="readlater" data-id="132+publication+1">
                                            <span role="button">
                                              <!--<span class="fa fa-link fa-wp-neutral-2 " aria-hidden="true" style="font-size:16px;"></span>-->
                                             Save to Read Later
                                            </span>
          ...
          <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><img src="https://pagevio.com/../../assets/images/help/close.png" alt="My Pic"></button>
                        <h4 class="modal-title">Report</h4>
                    </div>
                    <div class="modal-body">
                        <p class="model-issue">What's the issue?</p>
            ...
            var SelectionSharer = function (options) {
                    ...
                    var popoverHTML = '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                                   ...
                                   + '      <li><a class="action bookmark" onclick="Bookmarktool()" title="Bookmark this content">Tweet</a></li>'
                                     ...
                                     +'<span id="popup-hide2-1" style="left:0%;margin-top:31px;" class="popup-open commonpopup-hide-2 popuptext1 dropdown-menu dropdown-menu-add align-right popup-hide-2">'
                                              +'<ul class="popup-open" id="collection-list-item-1" style="left:19%;height:150px;overflow-x:hidden;">'
                                              +'<li class="list-group-item add-hover" style="background:white;color:#27A291;cursor:auto;width:200px;font-size:15px;">Choose Collection</li>'
                                                                                        +'<li  class="list-group-item add-hover" style="border:1px solid white;text-align:left;" onclick="SaveToCollectionSection(this)" data-id="0+343+3298"><span>New private</span>&nbsp;&nbsp'
                                              +'<i style="font-size: 16px;padding-top: 4px;margin-left: 10px;"  class="fa fa-globe"></i>&nbsp'
                                                                                         +'<i onClick="Get_collection_section(event,1,343,3298)" style="font-size:20px;" class="fa fa-angle-right"></i>'
                                                                                         +'</li>'
                                                                                      +'</ul>'
                                            +'<div id="section-list-item-1" class="popup-hide-2">'
                                                +'<ul id="popup-hide3-1" style="left:0%;height:150px;overflow-x:hidden;width:208px;" class="dropdown-menu align-right popup-open">'
                                            ...
                                            +'<div class="dropdown" id="create-colection-1">'
                                                +'<div  data-toggle="dropdown" style="text-align:center;background: #27a291 !important;color:white;cursor:pointer;padding-top:10px;padding-left:0px;" class="add-item add-hover dropdown-toggle" type="button" onclick="NewCollectionbox(3298)" onclick="" id="collapse-div-3298">'
                                                    +'<img src="https://pagevio.com/assets/images/help/white-add.png" />'
                                                    +'<span id="collapse-text">New Collection</span>'
                                                +'</div>'
                                            +'</div>'
                                            +'</span>';
                ...
                this.setElements = function (elements) {
                    ...
                    $(self.$elements).each(function(i,val){
                       ...
                       $(this).text()=="" ? "" :  $(this).prepend('<span><img onclick="AddBookmark(this,true)" src="https://pagevio.com/assets/images/icons/white_bookmark.png" class="out-bookmark"/></span>');
                        }
                    });
                    self.$elements.bind('touchstart', function (e) {
                        self.isMobile = true;
    ...
    function reminder(ele,j)
          {
            ...
            $.ajax({
                type:'post',
                url:"https://pagevio.com/program-details/store",
                data:{post_id:"3298",location:location,from:"3298",description:description,type:'promotion',title:title,startdate:startdate,endate:enddate,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success:function(result){
                    if(result.status=="success")
                    {
                    $('.alert-container').removeClass('alert-container-error');
        ...
        $(document).ready(function () {
         ...
         if(page[1]=="sample-page"){
          ...
          editable_elements[i].setAttribute("contenteditable", false);
            ...
            $.ajax({
                type:'post',
                url:"https://pagevio.com/program-details/store",
                data:{post_id:"3298",location:location,from:"3298",description:description,type:'event',len:dates.length,title:title,startdate:startdate,endate:enddate,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success:function(result){
                    if(result.status=="success")
                    {
                    $('.alert-container').removeClass('alert-container-error');
         ...
         $(".readlater").click(function () { 
            ...
            //console.log(result);
                $.ajax({
                    type: "post",
                    url: "https://pagevio.com/read-later",
                    data: {id:result[0],type:result[1],type_id:result[2],"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                    success: function(data){ 
                    console.log(data);
                    if (data.status == 'success') {
                        $('.alert-container').removeClass('alert-container-error');
            ...
            function Pintool()
            {
             ...
             var v=document.getElementById('create-colection-1');
                var v1=v.getElementsByTagName('span')[0];
                v.getElementsByTagName('img')[0].setAttribute('src',"https://pagevio.com/assets/images/help/white-add.png");
                v1.innerText="New Collection";
                v.getElementsByTagName('div')[0].setAttribute('onclick',"NewCollectionbox()");
                document.getElementById('demo-1').classList.add('collapse');
                document.getElementById('create-colection-1').classList.remove('popup-hide-2');
            ...
            function CreateCollection()
           {
            ...
            //var datastring = $("#frm").serialize();
                ...
                $.ajax({
                    type: "post",
                    url: "https://pagevio.com/store-collection",
                    data: {title:title,privacy:privacy,description:description,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                    cache: false,
                    success: function(data){
                        if (data.status == "success") {
                           $.ajax({
                           type: "post",
                           url: "https://pagevio.com/save-to-pins",
                           data: {page_id:page_id,type:'2',collection_id:data.id,section_id:0,Description:selectedtext,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                           success: function(data){ 
                           console.log(data);
     ...
     <script type="text/javascript">
         ...
         $('#follow').click(function (){
            ...
            $('#unfollow').click(function (e){
             ...
             $.ajax({
                type: "post",
                url: "https://pagevio.com/unfollow",
                data: {user_id:user_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){ 
        ...
        $(document).ready(function () {
            ...
            if(!(user_id)){
               ...
               $.ajax({
                type: "post",
                url: "https://pagevio.com/follow_verify",
                data: {user_id:user_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){ 
                    if (data == 'success') {
                         $('#follow').hide();
    ...
    //like
        $('#like_button').click(function(){
            ...
            $.ajax({
                type: "post",
                url: "https://pagevio.com/page-like",
                data: {page_id:page_id,from:from,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){
        ...
        $('#unlike_button').click(function(){
            ...
            $.ajax({
                type: "post",
                url: "https://pagevio.com/page-unlike",
                data: {page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){
         ...
         $(document).ready(function () {
             ...
             var page_id = "3298";
               ...
               $.ajax({
                type: "post",
                url: "https://pagevio.com/check-like",
                data: {page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success: function(data){
                //console.log(data); 
                    if (data.status == 'success') {
            ...
            $.ajax({
              type: "post",
              url: "https://pagevio.com/check-total-comment",
              data: {page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
              success: function(data){
                 if (data.status == 'success') { 
                    $('#total-comment').html(data.result);
    ...
    if(ongoingcomment)
        ...
        $('.send-msPopup').css('cursor','wait');
         ...
         $.ajax({
            type: "post",
            url: "https://pagevio.com/page-comment",
            data: {page_id:page_id,msg:msg,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success: function(data){
    ...
    $('.CommentClick').click(function(){
          ...
          var comment='<li class="card card-comment  card--small"><figure class="card-figure"><img src="http://pagevio.com/uploads/profile/1609915630.png" class="image--cover"></figure><div class="card-content"><div class="content-whatsapp-bottom"><input style=" border: 1px solid #27A291;" class="whats-input comment2" type="text"  placeholder="Leave a comment..." /><img class="send-msPopup" onclick="commentSend()" src="https://pagevio.com/assets/images/help/send.png" alt="My Pic"></div></div></li>';
    
          $.ajax({
            type: "post",
            url: "https://pagevio.com/get-all-comments",
            data: {page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success: function(response){
             var data = JSON.parse(response);
             if (data.status == 'success') {
                ...
                data.result.forEach(function(item, index){    
                 if(count>2)
                  {    if(item.field=='parent')
                      {
                      comment +='<li class="hidextracom card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="https://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.origin+'/'+item.avatar+'" class="image--cover"></figure><a><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" id="CommentReply'+item.id+'" type="text" placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                      else
                      {
                       comment +='<li style="padding-left:'+replypadding+'px;" class="hidextracom card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="https://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.origin+'/'+item.avatar+'" class="image--cover"></figure></a><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" id="CommentReply'+item.id+'" value="@'+item.username+'" type="text" placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\''+"child"+'\')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                      $('#cmtshowmore').show();
                  }
                  else
                  {
                      ...
                      {
                          ++count;
                      comment +='<li class="card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="https://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.origin+'/'+item.avatar+'" class="image--cover"></a></figure><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" id="CommentReply'+item.id+'" type="text"  placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                      else
                      {
                       comment +='<li style="padding-left:'+replypadding+'px;" class="card card-comment  card--small" id="AllComments"><figure class="card-figure"><a href="https://pagevio.com/author-profile/'+item.user_id+'"><img src="'+window.location.origin+'/'+item.avatar+'" class="image--cover"></a></figure><div class="card-content"><h4>'+item.username+'<span>'+dateToYMD(new Date(item.created_at))+'</span></h4><p>'+item.text+'</p><a class="reply" onclick="showReply('+index+')" id="reply_'+index+'">Reply</a><div class="content-whatsapp-bottom reply_box" id="reply_box_'+index+'" style="display:none;"><input style="border: 1px solid #27A291;width: 50%;margin-top:0px" class="whats-input comment2" id="CommentReply'+item.id+'" type="text" value="@'+item.username+'" placeholder="Leave a comment..."><img class="send-msPopup" onclick="commentSend('+item.parentId+',\'' +"child"+ '\','+item.id+')" src="https://arinos.co.uk/assets/images/help/send.png" alt="Send Reply" style="margin-top:0 !important;"></div></div></li>';
                      }
                  }
                 });
    ...
    //add TO collection
        ...
        /*            document.getElementById("list-item").style.height = "65px";*/
            ...
            var alert = $(".alert-container");
                $.ajax({
                    type: "post",
                    url: "https://pagevio.com/save-to-collection",
                    data: {id:result[0],type:result[1],type_id:result[2],page_id:page_id,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                    success: function(data){ 
         ...
         $('#create-collection').click(function(){
             ...
             if (name == '') {
              ...
              $.ajax({
                  type: "post",
                  url: "https://pagevio.com/create-collection",
                  data: {title:name,privacy:privacy,"_token": "L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                  success: function(data){ 
    ...
    function Report_Author(){
        ...
        $.ajax({
            type:'post',
            url:"https://pagevio.com/report-author",
            data:{authorid:"1",pageid:"3298",type:'page',reason:reason,ReportAdditional:ReportAdditional,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success:function(data){
                if(data.status=="success"){
                $('#myModal2').modal('show');
                }
    ...
    function SeriesSubscribe(post_id,author_id,type,status)
    {
        $.ajax({
            type:'post',
            dataType:'json',
            url:"https://pagevio.com/post-subscribe",
            data:{post_id:post_id,author_id:author_id,type:type,status:status,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
            success:function(result)
            {
                if(status==1)
                {
    ...
    function Bookmarktool()
         {
           ...
           $.ajax({
                type:'post',
                url:"https://pagevio.com/add-bookmark",
                data:{page_id:page_id,type:'select',data:selectedtext,line_number:line_number,selected_text:1,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                success:function(data)
                {
                    if(data.status=='success')
    ...
    function AddBookmark(img)
         {
             ...
             var data=img.parentElement.parentElement.innerText;
             var id=img.id;
             img.src=="https://pagevio.com/assets/images/icons/white_bookmark.png" ? 
             (
                 (img.src="https://pagevio.com/assets/images/icons/c_bookmark.png") &&
                 $('#msg').html("<span>Bookmark Added</span>&nbsp;&nbsp;<u style='cursor:pointer' onclick='bookmarkundo()'>undo</u>") &&
                         alert.slideDown() &&
                        window.setTimeout(function () {
                            //location.reload();
             ...
             window.setTimeout(function () {
                 ...
                 $.ajax({
                 type:'post',
                 url:"https://pagevio.com/delete-bookmark",
                 data:{id:id,"_token":"L31y9fo8PX8pyg6WQFWRuHdjZ15aMNx3Qr7EwZPv"},
                 success:function(result)
                 {
                     img.src="https://pagevio.com/assets/images/icons/white_bookmark.png";
         ...
         function ShowBookmark()
         {
            var bookmarks=[{"line_data":"Audio","line_number":4,"id":516},{"line_data":"Testing","line_number":7,"id":518},{"line_data":"Testing separator","line_number":9,"id":519},{"line_data":"Map","line_number":11,"id":520},{"line_data":"Form","line_number":15,"id":521},{"line_data":"Event","line_number":26,"id":522},{"line_data":"Promotion","line_number":27,"id":523},{"line_data":"Programme","line_number":28,"id":524},{"line_data":"Table","line_number":29,"id":525},{"line_data":"Accordian","line_number":32,"id":526},{"line_data":"Testing Quotes","line_number":6,"id":532},{"line_data":"Below attached image","line_number":1,"id":533}];
             var highlightt="";
             var highlighttext="";
             if(highlightt)
             {
             ...
             for(var iteration=0;iteration<bookmarks.length;iteration++)
             {
                 ...
                 $('.selectionShareable').each(function(i,val){
                    ...
                    if((!(str.search(l)==-1) || (str.length==l.length)) && (i+1==bookmarks[iteration].line_number))
                    {
                        var v=$(this).find('img');
                        v[0].id=bookmarks[iteration].id;
                        v[0].src="https://pagevio.com/assets/images/icons/c_bookmark.png" ;
                        if(!highlighttext){
                        return false;}
                    }
                 });
         ...
         {   var found=element[0].innerHTML;
             ...
             {
                 element[0].innerHTML=found.substring(0,t)+'<span class="highlight">'+found.substring(t,t+text.length)+'</span>'+found.substring(t+text.length);
                 $(element).find('img').attr('src',"https://pagevio.com/assets/images/icons/white_bookmark.png");
                 $('html, body').animate({
                     scrollTop: $(element).offset().top-80
                 }, 'slow');
             }
      ...
      <div class="footer">
         <div class="alert-container">
            ...
            <ul id="footer-items">
                ...
                <li><a href="#">About Us</a></li>
                <li><a href="#">Get a Creator Account</a></li>
                <li><a href="https://pagevio.com/TermsandConditions">Terms</a></li>
                <li><a href="#">Privacy</a></li>
                <li><a href="https://pagevio.com/help">Help</a></li>
                <li style="color:#909090">© 2019 PageVio</li>
            </ul>
        </div>
    <script src="https://pagevio.com/assets/web/js/selectbox.min.js"></script>
    <script>
        $(document).on("mouseup", function (event) {
            var p = $('.profile-dropdown');
